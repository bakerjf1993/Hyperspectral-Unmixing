...
if __name__ == '__main__':
    ...
    class BMAquad_elastic:
        ...
        def selectedindex_fit(self, mineral_type=None, region=None, **kwargs):
            self.technique = "BMA with Linear and Quadratic Terms - elasticnet"
            ...
            for pixel_sample in pixel_samples: 
                ...
                for self.num_elements in range(1, self.MaxVars + 1):
                    ...
                    for model_combination in current_model_set:
                        ...
                        elastic_model = ElasticNet(alpha=.0005, positive=True)
                        elastic_model.fit(model_X, self.y)
                        model_coefficients = elastic_model.coef_
