...
if __name__ == '__main__':
    ...
    class COMPARE:
        ...
        def run_techniques_multiple_times(self, mineral_type=None, region=None):
            ...
            for technique_name, TechniqueClass in techniques.items():
                ...
                if technique_name == 'STEPWISE':
                    ...
                    model_size = len(technique.non_zero_coefficients)
                    ...
                    technique.selectedindex_fit(mineral_type=mineral_type, region=region, MaxVars=3)                        
                    rmse = technique.min_rmse  
        ...
        def plot_results(self):
            colors = {'OLS': 'blue', 'NNLS': 'red', 'RIDGE': 'green', 'LASSO': 'purple', 'STEPWISE': 'orange','BMA':'black'}
