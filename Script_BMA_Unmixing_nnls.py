...
if __name__ == '__main__':
    ...
    class BMA:
        ...
        def selectedindex_fit(self, y_index=None, **kwargs):
            ...
            y_infer = np.dot(self.X, self.coefficients)
        ...
        def plot_spectra(self):
                ...
                plt.title(f"{self.technique}\nBest Model Variables ({self.num_elements} elements) - likelihood={self.max_likelihood}")
                ...
                for idx,name in zip(self.model_index_set,self.best_model_index_name):
